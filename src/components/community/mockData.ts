...
export const FOR_YOU_POSTS: Post[] = [
  {
    ...
    tags: ['Invest'],
    replierAvatars: [
      'https://picsum.photos/seed/replier-amara-1/80/80',
      'https://picsum.photos/seed/replier-amara-2/80/80',
    ],
  ...
  },
  {
    ...
    tags: ['Crypto'],
    replierAvatars: [
      'https://picsum.photos/seed/replier-crypto-1/80/80',
      'https://picsum.photos/seed/replier-crypto-2/80/80',
    ],
    moderationStatus: 'approved',
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    replierAvatars: ['https://picsum.photos/seed/replier-workshop-1/80/80'],
    moderationStatus: 'approved',
    createdAt: now,
    updatedAt: now,
  },
...
export const FOLLOWING_POSTS: Post[] = [
  {
    id: 'following-post-1',
    channelId: 'circle-wealth',
    channelName: 'Wealth Building',
    author: { id: 'u5', displayName: 'Nkechi Okonkwo', handle: '@Nkech_!' },
    content: "Switched my portfolio to ESG funds last year and haven't looked back — happy to share what I learned.",
    isAnonymous: false,
    isPinned: false,
    likeCount: 61,
    replyCount: 9,
    ...
    tags: ['Invest'],
    replierAvatars: [
      'https://picsum.photos/seed/replier-esg-1/80/80',
      'https://picsum.photos/seed/replier-esg-2/80/80',
    ],
    moderationStatus: 'approved',
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    content: 'Perseverance and patience made all the difference in my career pivot this year. Ask me anything!',
    isAnonymous: false,
    isPinned: false,
    likeCount: 44,
    replyCount: 12,
    ...
    timeAgo: '5h',
    tags: ['Career'],
    replierAvatars: ['https://picsum.photos/seed/replier-career-1/80/80'],
    moderationStatus: 'approved',
    createdAt: now,
    updatedAt: now,
  },
